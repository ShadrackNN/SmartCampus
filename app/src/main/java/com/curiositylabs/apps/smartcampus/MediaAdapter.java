...
public class MediaAdapter extends BaseExpandableListAdapter {
    ...
    public MediaAdapter(Context ctx,HashMap<String, List<String>> Year_Category,List<String> Year_List ){
        this.ctx = ctx;
    ...
    public View getGroupView(int parent, boolean isExpanded, View convertView, ViewGroup parentView) {
        ...
        if (convertView==null){
            ...
            convertView = inflater.inflate(R.layout.media_academics_list,parentView, false );
        }

        TextView parent_textView = (TextView) convertView.findViewById(R.id.media_list);
    ...
    public View getChildView(int parent, int child, boolean LastChild, View convertView, ViewGroup parentView) {
        ...
        if (convertView==null){
            LayoutInflater inflater =(LayoutInflater) ctx.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = inflater.inflate(R.layout.child_media_list, parentView, false);
        }
        TextView child_textView = (TextView) convertView.findViewById(R.id.media_child_list);
